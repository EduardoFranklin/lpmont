...
import { ArrowRight, ArrowLeft, Check, BookOpen, Radio, Users, Tag, CalendarCheck, MessageCircle, Calendar, Video, Loader2, CheckCircle2 } from "lucide-react";
                  ...
                  >
                    <motion.div
                      ...
                      animate={{ 
                        scale: [1, 1.05, 1],
                        boxShadow: [
                          "0 0 0 0 hsl(var(--brand-gold) / 0)",
                          "0 0 0 12px hsl(var(--brand-gold) / 0.08)",
                          "0 0 0 0 hsl(var(--brand-gold) / 0)"
                        ]
                      }}
                    ...
                    <h2 className="text-[1.3rem] font-extrabold text-foreground/95 leading-[1.2] mb-2">
                      Criando seu <span className="summit-text">agendamento...</span>
                    </h2>
                    <p className="text-[14px] text-foreground/40 leading-relaxed max-w-xs">
                      Estamos configurando sua reunião e enviando o convite para o seu calendário.
                    </p>
