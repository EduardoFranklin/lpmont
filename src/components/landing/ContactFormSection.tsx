...
import { ArrowRight, ArrowLeft, Check, BookOpen, Radio, Users, Tag, CalendarCheck, MessageCircle, Calendar, CheckCircle2 } from "lucide-react";
...
const ContactFormSection = () => {
  ...
  return (
    <section id="falar-equipe" className="py-20 sm:py-28 relative">
                    ...
                    <motion.div key="s3" variants={stepVariants} initial="initial" animate="animate" exit="exit" transition={{ duration: 0.3 }} className="flex flex-col items-center text-center py-4">
                      {calendarCreated ? (
                        <>
                          ...
                          <a href={`https://wa.me/5598991426777?text=${encodeURIComponent("Acabei de agendar uma reunião, tenho interesse em saber mais sobre o Método Mont.")}`} target="_blank" rel="noopener noreferrer" className="btn-summit w-full justify-center text-sm py-3.5 gap-2">
